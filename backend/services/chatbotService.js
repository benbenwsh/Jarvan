 ...
 */
export async function generateChatbotResponse(messages, businessPitch, questions) {
  ...
  for (let i = questions.length - 1; i >= 0; i--) {
    ...
    if (conversationText.toLowerCase().includes(questionLower.substring(0, 20))) {
      lastQuestionIndex = i;
      break;
    }
  }
...
${
  hasMoreQuestions
    ? `You should ask question ${nextQuestionIndex + 1}: "${nextQuestion.question}"`
